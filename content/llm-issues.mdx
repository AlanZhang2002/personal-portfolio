...
and gaining the ability to tell his story after a while. This argument for mentalese can also be seen in 
...
* Steven Pinker's book *The Language Instinct* (thanks Dr. Hartner), part of my readings for my Philosophy of Mind class 
that introduced the concept of mentalese to me.
* [This paper](https://arxiv.org/pdf/2409.13373) that discusses how to consider OpenAI's benchmark accomplishments 
with the o1 model.
* [a16z's AI Canon](https://a16z.com/ai-canon/), a somewhat older list of resources targeted for people who want to learn 
about LLMs and AI, including transformers. I did only skim some of this, with most of my understanding from my undergraduate 
classes and [3b1b's series on neural networks and LLMs](https://youtube.com/playlist?list=PLZHQObOWTQDNU6R1_67000Dx_ZCJB-3pi&feature=shared).
